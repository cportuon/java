...
public class CreacionVariables {
    ...
    public static void main(String[] args) {
        ...
        char c = 'c';                 // Un solo carácter Unicode
        String name = "Cosme";
